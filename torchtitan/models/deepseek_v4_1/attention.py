...
the teacher it rebuilds from them, lives on ``IndexerKLLoss``.
"""
    ...
    def forward(
        ...
        *,
        ...
        out = selected_attention(
            ...
            # TODO: run the fused triton/cute kernels once they validate this path; the
            # eager reference is what the CPU tests and the NPU ports run today.
            backend="eager",
