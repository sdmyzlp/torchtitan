...
_FROZEN_CLI_OPTIONS = frozenset(
    {
        ...
        "dataloader.pad_segments_to_multiple",
        ...
        "dataloader.sources.pad_segments_to_multiple",
        ...
        "validator.dataloader.pad_segments_to_multiple",
        ...
        "validator.dataloader.sources.pad_segments_to_multiple",
